...
<!-- Please read https://github.com/linuxserver/docker-openscad/blob/master/.github/CONTRIBUTING.md -->
...
# [linuxserver/openscad](https://github.com/linuxserver/docker-openscad)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fopenscad?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
[![GitHub Stars](https://img.shields.io/github/stars/linuxserver/docker-openscad.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-openscad)
[![GitHub Release](https://img.shields.io/github/release/linuxserver/docker-openscad.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-openscad/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-openscad/packages)
[![GitLab Container Registry](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitLab%20Registry&logo=gitlab)](https://gitlab.com/linuxserver.io/docker-openscad/container_registry)
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/openscad)
[![Docker Pulls](https://img.shields.io/docker/pulls/linuxserver/openscad.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/linuxserver/openscad)
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/openscad.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/openscad)
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-openscad%2Fjob%2Fmaster%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-openscad/job/master/)
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fopenscad%2Flatest%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/openscad/latest/index.html)

[OpenSCAD](https://openscad.org/) is a free software for creating solid 3D CAD objects. It is a script-only based modeller that uses its own description language; parts can be previewed, but cannot be interactively selected or modified by mouse in the 3D view. An OpenSCAD script specifies geometric primitives (such as spheres, boxes, cylinders, etc.) and defines how they are modified and combined (e.g., by intersection, difference, or union) to form a 3D model.

[![openscad](https://raw.githubusercontent.com/openscad/openscad/master/icons/512x512/openscad.png)](https://openscad.org/)

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://distribution.github.io/distribution/spec/manifest-v2-2/#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `lscr.io/linuxserver/openscad:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
To run OpenSCAD, follow these steps:

1. Start the Docker container using the provided `docker-compose` or `docker run` command.
2. Open a web browser and navigate to `https://<your-host-ip>:3001`.
3. You should now see the OpenSCAD interface.
...
services:
  openscad:
    image: lscr.io/linuxserver/openscad:latest
    deploy:
      resources:
        reservations:
          devices:
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/openscad:latest
```
...
| Parameter | Function |
| :----: | --- |
| `-p 3000:3000` | OpenSCAD desktop gui HTTP, must be proxied. |
| `-p 3001:3001` | OpenSCAD desktop gui HTTPS. |
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=openscad&query=%24.mods%5B%27openscad%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=openscad "view available mods for this container.") [![Docker Universal Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=universal&query=%24.mods%5B%27universal%27%5D.mod_count&url=httpshttps%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=universal "view available universal mods.")
...
* Shell access whilst the container is running:
    ...
    ```bash
    docker exec -it openscad /bin/bash
    ```

* To monitor the logs of the container in realtime:

    ```bash
    docker logs -f openscad
    ```

* Container version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' openscad
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/openscad:latest
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/openscad:latest
    ```

* Stop the running container:

    ```bash
    docker stop openscad
    ```
...
```bash
git clone https://github.com/linuxserver/docker-openscad.git
cd docker-openscad
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/openscad:latest .
```
